...
CANONICAL_FIELDS: List[CanonicalField] = [
    ...
    CanonicalField(
        ...
        aliases=[
            ...
            "min_bidder_average_annual_turnover_lakhs",
            "bidder_average_annual_turnover_lakhs",
            ...
            "bidder_average_annual_turnover_declared",
            "bidder_average_annual_turnover_audited",
        ],
        description="Multi-year (typically 3-year) average annual turnover certified by CA. Distinct from single-year turnover.",
    ),
    CanonicalField(
        canonical_id="OEM_AVERAGE_TURNOVER",
        label="OEM Average Annual Turnover",
        category=CanonicalCategory.FINANCIAL.value,
        family="TURNOVER",
        normalization_type="CURRENCY_CR",
        contradiction_eligible=True,
        aliases=[
            ...
            "oem_annual_turnover",
            "oem_min_turnover",
            "oem_average_annual_turnover_lakhs",
            "oem_average_turnover_lakhs",
            "minimum_average_annual_financial_turnover_of_the_oem",
            "oem_turnover_documentary_evidence",
            "oem_turnover_certificate",
        ],
        description="Original Equipment Manufacturer average annual turnover.",
    ),
    CanonicalField(
    ...
    CanonicalField(
        canonical_id="EPBG_DURATION_MONTHS",
        label="ePBG Duration (Months)",
        category=CanonicalCategory.FINANCIAL.value,
        family="EPBG",
        ...
        aliases=[
            ...
            "epbg_duration",
            "epbg_validity_months",
            "epbg_validity",
            "pbg_duration_months",
            "pbg_duration",
            "duration_of_pbg",
            "performance_bank_guarantee_duration",
        ],
        description="Duration or validity period in months required for Performance Bank Guarantee.",
    ),
    ...
    CanonicalField(
        ...
        aliases=[
            ...
            "class_i_local_content",
            "class_ii_local_content",
            "class_i_local_supplier",
            "class_ii_local_supplier",
            "class_i_local_content_percentage",
            "local_content_declared",
            "class_1_local_content_threshold",
            "class_2_local_content_threshold",
            "local_content_requirement",
            "mii_local_content_percentage",
            ...
            "mii_status",
            "mii_supplier_class",
            "allow_participation_only_from_class_1_class_2_local_suppliers",
        ],
    ...
    CanonicalField(
        canonical_id="LAND_BORDER_DECLARATION",
        label="Land Border Rule 144(xi) Compliance Undertaking",
        category=CanonicalCategory.ELIGIBILITY.value,
        family="LAND_BORDER",
        normalization_type="BOOLEAN",
        contradiction_eligible=True,
        aliases=[
            "land_border_compliance",
            "land_border_declaration",
            "land_border_sharing",
            "land_border_sharing_declaration",
            "land_border_rule_144_xi",
            "land_border_compliance_undertaking",
            "land_border_sharing_registration",
            "land_border_registration",
            "land_border_rule_compliance",
            "land_border_undertaking",
            "land_border_declaration_certificate",
            "restrictions_under_rule_144_xi",
        ],
        description="Mandatory statutory declaration under GFR Rule 144(xi) and GeM GTC Clause 26 regarding land border restrictions.",
    ),
    CanonicalField(
        canonical_id="BOQ_TECHNICAL_COMPLIANCE",
        label="Technical Specification and BoQ Compliance",
        category=CanonicalCategory.TECHNICAL_SPEC.value,
        family="TECHNICAL_SPEC",
        normalization_type="BOOLEAN",
        contradiction_eligible=True,
        aliases=[
            "boq_compliance",
            "boq_compliance_document",
            "technical_specification_compliance",
            "technical_compliance",
            "boq_specification_compliance",
            "compliance_of_boq_specification",
        ],
        description="Affirmative compliance with Bill of Quantities (BoQ) and buyer technical specifications.",
    ),
    CanonicalField(
        canonical_id="LABOUR_LAW_COMPLIANCE",
        label="Statutory Labour Law Compliance Undertaking",
        category=CanonicalCategory.ELIGIBILITY.value,
        family="STATUTORY_COMPLIANCE",
        normalization_type="BOOLEAN",
        contradiction_eligible=True,
        aliases=[
            "labour_law_compliance",
            "labour_laws_compliance",
            "labour_codes_compliance",
            "statutory_labour_compliance",
            "pre_existing_labour_laws",
            "labour_compliance_undertaking",
        ],
        description="Undertaking to adhere strictly to statutory labour enactments and the Labour Codes.",
    ),
    ...
    CanonicalField(
        ...
        aliases=[
            ...
            "years_of_past_experience_required_for_samesimilar_service",
            "years_of_past_experience",
            "experience_criteria",
            "experience_documentary_evidence",
            "experience_proof",
    ...
    CanonicalField(
        canonical_id="PAST_PERFORMANCE_PERCENT",
        label="Past Performance Percentage",
        category=CanonicalCategory.ELIGIBILITY.value,
        family="EXPERIENCE",
        normalization_type="PERCENT",
        contradiction_eligible=True,
        aliases=[
            ...
            "past_performance_quantity",
            "past_performance_quantity_claimed",
            "past_performance_quantity_actual",
            "past_performance_percent",
            "past_performance",
            "past_performance_requirement_percentage",
            "past_performance_proof",
            "past_performance_document",
        ],
        description="Past performance percentage or supply volume threshold of bid quantity.",
    ),
]
